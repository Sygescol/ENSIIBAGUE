...
import InfoAdministativos from "./InfoAdministativos";
  ...
  return (
    <div className="grid sm:grid-cols-10 h-full ">
        ...
        <div className="  bg-slate-50 border-r h-auto flex flex-col">
          ...
          <div className=" h-[400px] overflow-y-auto">
            {users?.map((data: any, key: any) => (
              ...
              >
                <div className="ml-4">
                  <p className="text-md font-semibold text-slate-600 m-0 p-0 uppercase">
                    {data && data?.nombre
                      ? `${data.nombre}`
      ...
      <div className="sm:col-span-7 h-auto">
        <InfoAdministativos info={info} />
      </div>
    </div>
  );
};

export default LayoudAdmnistrativos;
